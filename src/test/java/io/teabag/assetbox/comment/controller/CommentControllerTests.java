...
import io.teabag.assetbox.post.controller.PostController;
...
class CommentControllerTests {
    ...
    @Nested
    @DisplayName("댓글 생성")
    class Comment_생성관련_테스트{
        CommentCreateRequest request;
        Post post;
        @BeforeEach
        void setUp(){
            request = TestUtil.commentCreateRequestOf();
            post = TestUtil.postOf();
        }
        ...
        void createComment() throws Exception {
            ...
            given(commentService.save(any(PostCreateRequest.class)))
